...
export default function PetResults({ petType, statGoal, }: {
  petType: string;
  statGoal: number;
}) {
  ...
  return (
    <div>
      { costFromActionCount(calculatePetCost([1,], petType, statGoal)["[1]"][0].actionCount) }
    </div>
  );
}
...
const costSac: { [key: string]: number } = {
  "e": 6000000,
  "d": 20000000,
  "c": 57500000,
  "b": 120000000,
...
function calculatePetCost(startState: number[], petType: string, goal: number) {
